...
/* 
*  Fun Fact: On May 2021, one Zionist in his Twitter can't stand with 'Malaysians Onion Army' trolls. 
*  History was made where online trolls successfully 'koyak' those who support Zionists Occupation and Oppression of Palestinians.
*  Let The World Witness The Gross Injustice Over The Life Of Palestinians.
*
*  KOYAK Features
*  - 4% Deposited to Donation Wallet
...
contract Koyak is Context, IBEP20, Ownable {
  using SafeMath for uint256;
  using Address for address;

  string private _name = "Koyak";
  string private _symbol = "KOYAK";
